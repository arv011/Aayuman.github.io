...
import heroImage from "@/assets/a15.jpeg";
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center text-white translate-y-20">
        ...
        <h1 className="mb-4 animate-fade-in font-playfair text-3xl font-bold md:text-8xl">
          & AayuMan &
        </h1>
        ...
        <div className="mb-12 flex gap-2 animate-fade-in" style={{ animationDelay: "0.4s" }}>
          <div className="flex flex-col items-center rounded-lg bg-white/20 backdrop-blur-sm px-5 py-4">
