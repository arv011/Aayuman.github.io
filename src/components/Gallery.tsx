...
import gallery1 from "@/assets/a2.jpeg";
import gallery2 from "@/assets/a10.jpeg";
import gallery3 from "@/assets/a4.jpeg";
import gallery4 from "@/assets/a14.jpeg";
import gallery5 from "@/assets/a9.jpeg";
import { Dialog, DialogContent } from "@/components/ui/dialog";import { useScrollAnimation } from "@/hooks/useScrollAnimation";
...
const Gallery = () => {
  ...
  const images = [
    ...
    { src: gallery5, alt: "Wedding invitation", animation: "animate-slide-in-left" },
  ];
